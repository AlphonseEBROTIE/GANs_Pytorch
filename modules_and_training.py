...
def TimeGAN(data, parameters,learning_rates):
  """
  Main workhorse function of timegan
  Args: 
    - data = Time series data
    - parameters = dictionary of training parameters
    - learning_rates = vecteur qui contient les lr dans l'ordre :
    [embedder,recovery,supervisor,discriminator,generator]
  ...
  """
  lr_embedder = learning_rates[0]
  lr_recovery = learning_rates[1]
  lr_supervisor = learning_rates[2]
  lr_discriminator = learning_rates[3]
  lr_generator = learning_rates[4]
  ...
  embedder_optimizer = optim.Adam(Embedder.parameters(), lr=lr_embedder) #0.0035
  recovery_optimizer = optim.Adam(Recovery.parameters(), lr=lr_recovery) #0.01
  supervisor_optimizer = optim.Adam(Recovery.parameters(), lr=lr_supervisor) #0.001
  discriminator_optimizer = optim.Adam(Discriminator.parameters(), lr=lr_discriminator) #0.01
  generator_optimizer = optim.Adam(Generator.parameters(), lr=lr_generator) #0.01
  ...
  print('Début entrainement de l''Embedding Network ')
  ...
  print('Fin Training avec la Supervised Loss ')
  
  
  # Joint Training
  print('Début Training conjoint')
  ...
  print('Fin du Training conjoint')
